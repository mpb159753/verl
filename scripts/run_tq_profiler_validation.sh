...
# 验证 TransferQueue Profiler 标记功能的脚本 (GPU 版本)
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen0.5b-gsm8k-tq-profiler-gpu' \
    ...
    global_profiler.save_path=./outputs/tq_profiler_validation_gpu \
    transfer_queue.enable=True \
    "$@"

echo "====================================="
echo "验证完成！"
echo "请使用 nsys-ui 查看 profiling 结果："
echo "  nsys-ui ./outputs/tq_profiler_validation_gpu/*.qdrep"
echo ""
