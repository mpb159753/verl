...
# 模型路径配置 (请填写绝对路径)
# =====================================================
MODEL_QWEN_0_5B="/home/m00594701/models/Qwen2.5-0.5B-Instruct"
MODEL_QWEN_7B="/home/m00594701/models/Qwen2.5-7B-Instruct"
MODEL_QWEN_14B="/home/m00594701/models/Qwen2.5-14B-Instruct"

# =====================================================
# 数据集路径配置 (请填写绝对路径)
# =====================================================
DATASET_GSM8K_TRAIN="/home/m00594701/dataset/gsm8k/train.parquet"
DATASET_GSM8K_TEST="/home/m00594701/dataset/gsm8k/test.parquet"
DATASET_ULTRACHAT_TRAIN="/home/m00594701/dataset/ultrachat_200k/train.parquet"
DATASET_ULTRACHAT_TEST="/home/m00594701/dataset/ultrachat_200k/test.parquet"
DATASET_LONGBENCH_TRAIN="/home/m00594701/dataset/longbench/train.parquet"
DATASET_LONGBENCH_TEST="/home/m00594701/dataset/longbench/test.parquet"
DATASET_SHAREGPT4V_TRAIN="/home/m00594701/dataset/sharegpt4v/train.parquet"
DATASET_SHAREGPT4V_TEST="/home/m00594701/dataset/sharegpt4v/test.parquet"
...
analyse(profiler_path='${STEP_15_DIR}', export_type='db')
"
    else
...
declare -a TESTS=(
    ...
    "T-05 ${MODEL_QWEN_7B} ${DATASET_SHAREGPT4V_TRAIN} ${DATASET_SHAREGPT4V_TEST} 64 32768 1 1"
)
